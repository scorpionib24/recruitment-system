...
<div class="container-fluid">
    <div class="card">
        <div class="card-header">
            {{-- تعديل 1: تغيير العنوان --}}
            <h5>تعديل بيانات الموظف: {{ $employee->first_name }} {{ $employee->last_name }}</h5>
        </div>
        <div class="card-body">
            {{-- تعديل 2: تغيير الـ action --}}
            <form action="{{ route('dashboard.employees.update', $employee->id) }}" method="POST">
                @csrf
                @method('PUT') {{-- تعديل 3: إضافة @method('PUT') --}}
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        {{-- تعديل 4: ملء الحقل بالبيانات الحالية --}}
